...
/*---------------------------- SPIx CTLR1 Configuration ------------------------*/
  /* Get the SPIx CTLR1 value */
  tmpreg = SPIx->CTLR1;
...
/**
  ...
  *     operation to SPI_STR register (SPI_I2S_GetFlagStatus()).
  *   - UDR (UnderRun error) flag is cleared by a read operation to 
  *     SPI_STR register (SPI_I2S_GetFlagStatus()).
  *   - MODF (Mode Fault) flag is cleared by software sequence: a read/write 
  *     operation to SPI_STR register (SPI_I2S_GetFlagStatus()) followed by a 
...
ITStatus SPI_I2S_GetITStatus(SPI_TypeDef* SPIx, uint8_t SPI_I2S_IT)
{
  ...
  if (((SPIx->STR & itpos) != (uint16_t)RESET) && enablestatus)
  {
    /* SPI_I2S_IT is set */
    bitstatus = SET;
  }
...
/**
  ...
  *     sequence: a read operation to SPI_DTR register (SPI_I2S_ReceiveData()) 
  *     followed by a read operation to SPI_STR register (SPI_I2S_GetITStatus()).
  *   - UDR (UnderRun Error) interrupt pending bit is cleared by a read 
  *     operation to SPI_STR register (SPI_I2S_GetITStatus()).
  *   - MODF (Mode Fault) interrupt pending bit is cleared by software sequence:
  *     a read/write operation to SPI_STR register (SPI_I2S_GetITStatus()) 
